            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                            <button class='btn btn-primary' onclick='editarCategoria(" . $row['idCategoria'] . ")'>Editar</button>
                            <button class='btn btn-danger' onclick='confirmarEliminar(" . $row['idCategoria'] . ")'>Eliminar</button>
                        </td>";
                        echo "</tr>";
                        $contador++;
                    }
