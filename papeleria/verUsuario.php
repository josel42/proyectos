...
include('controladores/contVerUsuario.php');
        ...
        <div class="container">
            ...
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nuevoNombre" required value="<?php echo $userData['nombreUsuario']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevoApellido" class="col-sm-3 col-form-label">Apellido:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nuevoApellido" required value="<?php echo $userData['apellido']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevoUsuario" class="col-sm-3 col-form-label">Usuario:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nuevoUsuario" required value="<?php echo $userData['usuario']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevaContra" class="col-sm-3 col-form-label">Contraseña:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nuevaContra" required value="<?php echo $userData['contra']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevaEdad" class="col-sm-3 col-form-label">Edad:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nuevaEdad" required value="<?php echo $userData['edad']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevoEmail" class="col-sm-3 col-form-label">Email:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="nuevoEmail" required value="<?php echo $userData['email']; ?>" readonly>
                    </div>
                </div>
                <!-- Botones de acción -->
                <div class="form-group row">
