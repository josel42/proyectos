...
include('controladores/contCreateUsuario.php');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <form action="" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="apellido" required placeholder="Ingrese su apellido">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevoUsuario" class="col-sm-3 col-form-label">Usuario:</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="usuario" required placeholder="Ingrese su usuario">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="nuevaContra" class="col-sm-3 col-form-label">Contraseña:</label>
                    <div class="col-sm-4">
                        <input type="text" class="form-control" name="contra" required placeholder="Ingrese su contraseña">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <button type="submit" class="btn btn-light" name="submit" value="Crear Usuario">Crear Usuario</button>
