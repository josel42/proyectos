            ...
            <tbody>
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                            <button class='btn btn-primary' onclick='editarUsuario(" . $row['idUsuario'] . ")'>Editar</button>
                            <button class='btn btn-danger' onclick='confirmarEliminar(" . $row['idUsuario'] . ")'>Eliminar</button>
                        </td>";
                        echo "</tr>";
                        $contador++;
                    }
