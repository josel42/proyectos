...
<head>
    ...
    <title>Proveedor no se puede eliminar</title>
...
<body>
    <div class="container">
        <h1>No se puede eliminar el proveedor</h1>
        <p>El proveedor no puede ser eliminado debido a relaciones existentes en las siguientes tablas:</p>
        <table>
            <thead>
                <tr>
                    <th>Tabla</th>
            ...
            <tbody>
                ...
                foreach ($relaciones as $relacion) {
                    ...
                    if ($relacion == 'productos') {
                        $sql_detalle = "SELECT * FROM productos WHERE idProveedor = ?";
                        $stmt_detalle = mysqli_prepare($conn, $sql_detalle);
                        mysqli_stmt_bind_param($stmt_detalle, "i", $idProveedor);
        ...
        <button class="btn btn-primary" onclick="window.location.href='verProveedores.php'">Volver</button>
    </div>
</body>
